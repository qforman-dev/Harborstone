...
if (form) {
 ...
 if (FORM_ENDPOINT) { button.innerHTML = 'Request My Free Estimate <span>↗</span>'; document.querySelector('#form-note').textContent = 'Your details will be used to respond to your request. Please read the Privacy Policy before submitting.'; }
